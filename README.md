...
| | |
|---|---|
| **Base URL** | `https://assignment-production-e91b.up.railway.app` *(update after deployment)* |
| **Docs (Swagger)** | `https://assignment-production-e91b.up.railway.app/docs` |
| **Health check** | `GET /` |

### Quick login test against live deployment
```bash
curl -s -X POST https://assignment-production-e91b.up.railway.app/auth/login \
